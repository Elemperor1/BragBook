      ...
      <div className="shell-panel sticky top-6 flex min-h-[calc(100vh-3rem)] flex-col rounded-[2rem] border border-white/75 px-6 py-7">
        <div className="space-y-5">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-[1.25rem] bg-ink text-lg font-semibold text-ink-foreground shadow-[var(--shadow-card)]">
              BB
            </div>
            <div className="space-y-1">
              <p className="font-display text-[1.65rem] leading-none tracking-[-0.05em] text-foreground">
                BragBook
              </p>
          ...
          <div className="surface-feature rounded-[1.5rem] border border-white/10 p-4 text-[#f7f1e8]">
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-[#cfbea9]">
              Operating mode
            </p>
          ...
          {navigationItems.map((item, index) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "flex items-start gap-4 rounded-[1.25rem] px-4 py-4 transition",
                  isActive
              ...
              >
                <span
                  className={cn(
                    "mt-0.5 font-mono text-xs tracking-[0.24em]",
                    isActive ? "text-[#cfbea9]" : "text-muted-foreground",
                  )}
                >
                  0{index + 1}
                </span>
        ...
        <div className="surface-quiet mt-auto rounded-[1.5rem] border border-border/70 p-4">
